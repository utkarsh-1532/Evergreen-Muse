...
import { ThumbsDown, Brain, Sparkles, X } from 'lucide-react';
...
interface ReviewModalProps {
  ...
  onUpdateSeedReview: (seed: WithId<LearningSeed>, result: ReviewResult) => void;
}

export function ReviewModal({ isOpen, onOpenChange, dueSeeds, onUpdateSeedReview }: ReviewModalProps) {
  ...
  const handleReview = (result: ReviewResult) => {
    ...
    onUpdateSeedReview(currentSeed, result);
